...
``` {r}
males_no_backpain <- backpack %>% 
  filter((back_problems == 0) & (sex == "Male")) %>% 
  nrow() 


males_backpain_proportion <- backpack %>% 
  filter((back_problems == 1) & (sex == "Male")) %>% 
  nrow() / (males_no_backpain) 

males_backpain_proportion
```

0.22 is the proportion of men suffering from back pain


```{r}
females_no_backpain <- backpack %>% 
  filter((back_problems == 0) & (sex == "Female")) %>% 
  nrow() 


females_backpain_proportion <- backpack %>% 
  filter((back_problems == 1) & (sex == "Female")) %>% 
  nrow() / (females_no_backpain) 

females_backpain_proportion
```

0.77 is the proportion of women who suffer from backpain
